const MemberNoteRepository = require('../database/repositories/memberNoteRepository');
const ValidationError = require('../errors/validationError');
const AbstractRepository = require('../database/repositories/abstractRepository');

module.exports = class MemberNoteService {
  ...
  async findByMemberId(id) {
    return this.repository.findAndCountAllById(id);
  }
